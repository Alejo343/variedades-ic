...
function ProductCard({ product, delay }: { product: typeof PRODUCTS[0]; delay: number }) {
  ...
  return (
    <article
      ref={ref}
      className="v3-scroll-reveal group"
      style={{
        background: '#060f1d',
...
export default function FeaturedProducts3() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Header */}
        <div ref={headerRef} className="v3-scroll-reveal" style={{ marginBottom: '48px', display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: '24px' }}>
          <div>
